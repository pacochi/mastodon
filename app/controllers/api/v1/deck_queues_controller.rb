...
class Api::V1::DeckQueuesController < Api::BaseController
  ...
  rescue Mastodon::MusicSourceNotFoundError
    render json: { error: '動画を追加できません。 （？）ボタンから、対応サービスを確認ください。' }, status: :bad_request
  rescue Mastodon::MusicSourceFetchFailedError
    render json: { error: '動画を取得できませんでした。' }, status: :bad_request
