...
class HomeTimeline extends React.PureComponent {
  ...
  render () {
    ...
    if (hasFollows) {
      ...
      emptyMessage = <FormattedMessage id='empty_column.home' defaultMessage="You aren't following anyone yet. Visit {public} or use search to get started and meet other users." values={{ public: <Link to='/suggested_accounts'><FormattedMessage id='empty_column.home.suggested_accounts' defaultMessage='the active accounts' /></Link> }} />;
    }
