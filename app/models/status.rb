...
class Status < ApplicationRecord
  ...
  scope :with_public_visibility, -> { where(visibility: :public).where("statuses.created_at <= CURRENT_TIMESTAMP AT TIME ZONE 'UTC'") }
  ...
  class << self
    ...
    def permitted_for(target_account, account)
      ...
      if account.nil?
        where(visibility: visibility).where("statuses.created_at <= CURRENT_TIMESTAMP AT TIME ZONE 'UTC'")
