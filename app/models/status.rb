...
class Status < ApplicationRecord
  ...
  cache_associated :application, :media_attachments, :tags, :stream_entry, :pixiv_cards, mentions: { account: [:pinned_statuses, :oauth_authentications] }, reblog: [{ account: :oauth_authentications }, :application, :stream_entry, :tags, :media_attachments, :pixiv_cards, :pinned_status, mentions: { account: [:pinned_statuses, :oauth_authentications] }], thread: { account: [:pinned_statuses, :oauth_authentications] }, account: [:pinned_statuses, :oauth_authentications]
