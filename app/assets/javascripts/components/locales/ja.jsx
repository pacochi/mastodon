const ja = {
  ...
  "onboarding.page_two.compose": "フォームから投稿できます。イメージや、公開範囲の設定や、表示時の警告の設定は下記のアイコンから行なえます。",
  "onboarding.page_three.search": "検索バーを使うと、{illustration}や{introductions}のようにして、ユーザーを探したりハッシュタグを見たりできます。",
  "onboarding.page_three.profile": "「プロフィールを編集」から、あなたの自己紹介や表示名を変更できます。またそこで他の設定を探すこともできます。",
  "onboarding.page_four.home": "「ホーム」タイムラインではあなたがフォローしている人の投稿を表示します。",
  "onboarding.page_four.notifications": "「通知」ではあなたへの他の人からの関わりを表示します。",
  "onboarding.page_five.public_timelines": "連合タイムラインでは{domain}の人がフォローしている全員の公開投稿を表示します。ローカルタイムラインではほぼ同じですが{domain}の投稿に限定します",
  ...
  "privacy.direct.long": "言及したユーザーだけに公開",
