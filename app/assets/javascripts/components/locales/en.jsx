...
const en = {
  ...
  "time_limit.minutes": "{minutes, number} {minutes, plural, one {minute} other {minutes}}",
  "time_limit.hours": "{hours, number} {hours, plural, one {hour} other {hours}}",
  "time_limit.select_time_limit": "Select time limit",
